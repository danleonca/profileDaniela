...
function printProjects(){
    ...
    <div id="projects">
        ...
        <a title="Ver app" href="https://shari12.github.io/CDMX009-Data-Lovers/" target="_blank"><img id="imgFirstProject" class= "imgProject" src="img/pokemon.svg" /></a>
            ...
            <p>Data Lover de pókemon GO es una app creada para apoyar a los maestros pokemones en su busqueda por ser más fuertes, está app consume el set de datos de todos los pokemones de la región Kanto y crea una interfaz web donde se puede visualizar y manipular data, para que el usuario pueda acceder a ellos de forma eficiente.
...
function showMe(){
    let printSP= document.getElementById('perfilConteiner');
    let myDescription=`<div><div id="quote"><p>"Nada en este mundo debe ser temido... sólo entendido. Ahora es el momento de comprender más, para que podamos temer menos"</p>
    <p> Marie Curie </p></div>
